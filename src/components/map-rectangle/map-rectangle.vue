    ...
    <div class="leftMenu">
        <h2>台站筛选选项</h2>
            <!-- <p>
                ...
                <select class='system' v-model="formData.system">
                    <option value="LTE">LTE</option>
                    <option value="CDMA-2000">CDMA-2000</option>
            ...
            <p>
                <label>业务类型</label>
                <select class='service' v-model="formData.service">
...
<script src="./map-rectangle.js"></script>